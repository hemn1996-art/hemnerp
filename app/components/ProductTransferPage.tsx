...
export default function ProductTransferPage({ headerSelector, editId }: Props) {
  ...
  useEffect(() => {
    ...
    checkFn.owner = 'ProductTransferPage.tsx';
    (window as any).hasUnsavedChanges = checkFn;
    return () => {
      if ((window as any).hasUnsavedChanges && (window as any).hasUnsavedChanges.owner === 'ProductTransferPage.tsx') {
  ...
  function handlePrint() {
    ...
    openPrintWindow("product-transfer-print-area");
  }
