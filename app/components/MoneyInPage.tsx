...
const leftPanel: CSSProperties = { background: "white", border: "1px solid #e5e7eb", borderRadius: 18, padding: 16, position: "sticky", top: 16, height: "calc(122vh - 40px)", maxHeight: "calc(122vh - 40px)", overflowY: "auto" };
