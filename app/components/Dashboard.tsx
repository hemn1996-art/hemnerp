                        ...
                        <span
                          onClick={(e) => {
                            ...
                            const mappedType = (
                              ...
                              raw === "my_debt" || raw === "من قەرزارم" || raw === "من قەرزارم" || raw === "من قەرزدارم" ? "my_debt" :
                              raw === "people_debt" || raw === "قەرزم لای خەڵکە" || raw === "قەرزم لای خەڵکە" ? "people_debt" :
                              raw === "my_debt_discount" || raw === "داشکاندنم بۆ کراوە" ? "my_debt_discount" :
                              raw === "people_debt_discount" || raw === "داشکاندنم کردوە" ? "people_debt_discount" :
