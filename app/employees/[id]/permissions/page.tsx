...
const PERMISSION_GROUPS = [
  {
    ...
    modules: [
      ...
      { key: "vouchers_my_debt", label: "پسووڵەی من قەرزارم" },
      { key: "vouchers_people_debt", label: "پسووڵەی قەرزم لای خەڵکە" },
      { key: "vouchers_debt_discount_mine", label: "داشکاندنم بۆ کراوە" },
      { key: "vouchers_debt_discount_people", label: "داشکاندنم کردوە" },
