const fs = require('fs');
const path = 'app/components/PeopleDebtDiscountPage.tsx';
let content = fs.readFileSync(path, 'utf8');

const targetLine = '  const [debtAmount, setDebtAmount] = useState("");';
...
console.log("Fixed PeopleDebtDiscountPage.tsx");
